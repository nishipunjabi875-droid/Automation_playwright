...
test('Check 404 links on WoodenStreet domain', async ({ page, request }) => {
    test.setTimeout(120000); // 2 minutes timeout for the test
    ...
    if (brokenLinks.length === 0) {
        console.log('✅ SUCCESS: No 404 or broken links found!');
    } else {
